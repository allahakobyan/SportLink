...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [33 x i8] c"com.companyname.sportlink.mobile\00", align 1
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [31 x i8] c"libaot-SportLink.Shared.dll.so\00", align 1
@.DSOCacheEntry.9_name = private unnamed_addr constant [31 x i8] c"libaot-SportLink.Mobile.dll.so\00", align 1
